...
#'
#'
#' @usage read_multiple_fxout(multiple_path, visualize = TRUE)
#' # read multiple fxout files
#' @param path path to multiple files with .fxout extension.
#' @param visualize if TRUE, you will get a visualization of Total energy distribution of all fxout files.
#' @return dataframe of all foldx output exist in that path
#'
#' @details
